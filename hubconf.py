...
def cd_imagenet64(pretrained=True, **kwargs):
    from diffusers import ConsistencyModelPipeline
    model_id_or_path = "openai/diffusers-ct_imagenet64"
    # model_id_or_path = "openai/diffusers-ct_bedroom256"
    pipe = ConsistencyModelPipeline.from_pretrained(model_id_or_path, use_safetensors=True)
    model = pipe.unet
    scheduler = pipe.scheduler
    return model, scheduler, pipe
