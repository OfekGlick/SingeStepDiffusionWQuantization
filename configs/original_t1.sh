...
#SBATCH --job-name="original_t1"           # Name of the job
...
#SBATCH -o logs/original_t1_%N_%j_out.txt      # stdout goes here
#SBATCH -e logs/original_t1_%N_%j_err.txt      # stderr goes here
